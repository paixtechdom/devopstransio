    ...
    return(
        <div className="w-full center mt-[10vh]">
            <div className="w-11/12 lg:w-10/12 center flex-col  gap-[10vh] ">
                ...
                <div className="flex flex-col gap-y-[15vh] lg:gap-[20vh]">
                    {
...
const ServicesComponent:FC<cardInterface> = ({img, title, desc, index}) => {
    ...
    return(        
        <div 
            onClick={() => dispatch(setCurrentService(index))} 
            className={`cursor-pointer flex items-center relative
            ${index % 2 == 0 ? "lg:flex-row justify-start" : "lg:flex-row-reverse justify-end"} bg -red-500
        `}>
            <div className="h-[50vh] lg:h-[45vh] w-full lg:w-4/12 rounded-2xl overflow-hidden shadow-xl">
            ...
            <div className={`flex flex-col p-6 rounded-2xl gap-6 shadow-xl w-11/12 lg:w-6/12 absolute lg:relative bg-opacity-60 backdrop-blur-2xl
                ${index % 2 == 0 ? "bg-secondary lg:-translate-x-[15%]" : 
                "bg-primary lg:translate-x-[15%]"}`}>
