...
export const WhyUs : React.FC =  () => {
    return(
        <div className="w-full center my-[10vh]">
            <div className="w-11/12 lg:w-10/12 flex flex-col lg:flex-row rounded-2xl bg-primary bg-opacity-50 p-6 md:p-8 lg:p-12 gap-y-9 gap-3 text-white shadow-xl">
                {
                    whyWeStandOut.map((why :any, i) => (
                        <Parallax key={i} id={TrimText(why.title)} 
                            ...
                            className="w-full">
                            <div className="w-full flex flex-col gap-1 bg-secondary shadow-xl border border-primary border-opacity-90 rounded-xl p-5 relative py-8">
