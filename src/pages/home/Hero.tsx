...
export const Hero: React.FC = () => {
    return(
        <div className="min-h-[110vh] bg-hero bg-center bg-cover w-full center lg:pb-[10vh] z-6 relative"> 
            <div className="w-11/12 lg:w-10/12 xl:w-9/12 flex flex-col justify-center items-start">
                <div className="w-full lg:w-8/12 flex flex-col justify-center items-start text-white gap-4">
                    ...
                    <h1 className="font-bold text-primary text-4xl lg:text-5xl tracking-wide">
                        LET’S LIFT YOUR
