    ...
    <section className="w-full center my-[15vh] mb-[25vh]">
        <div className="flex flex-col-reverse w-11/12 lg:w-10/12 lg:flex-row justify-between gap-[50px] gap-y-12">
            <div className="w-full lg:w-11/12 relative flex flex-col">
                <div className="h-[30vh] lg:h-[35vh] w-9/12 rounded-3xl shadow-lg shadow-primary overflow-hidden">
                    <img src={img1} alt="" className="w-full h-full object-cover"/>
                </div>
                <div className="h-[30vh] lg:h-[35vh] w-9/12 absolute top-[50%] right-0 rounded-3xl shadow-lg shadow-primary overflow-hidden center">
